...
optimize_prompt(idea): Entfernt Füllwörter und bildet eine neue Anweisung, um Tokens zu sparen.

ProjectManagerMenu
Das interaktive Menü ist extrem umfangreich und dient als Schaltzentrale:
